...
<p>
  Aventure-se na criação do campeão perfeito, compartilhe seu talento com o mundo e faça história em League of Legends.
    ...
    images: [
      ...
      'https://github.com/user-attachments/assets/89895be3-8d30-4940-aa3c-558d1d769638',
      'https://github.com/user-attachments/assets/68d04fb3-1614-43e2-867e-2e64498ded50',
      'https://github.com/user-attachments/assets/17d5143e-bf49-4be6-92d2-bb52957c94db',
...
<p>
  ...
  de acordo com suas preferências, garantindo conforto visual em qualquer ambiente de uso.
    ...
    images: [
      ...
      'https://github.com/user-attachments/assets/99b71c8a-d5a2-4267-86e2-c67a8622e913',
      'https://github.com/user-attachments/assets/1f5cbbfd-19fc-43ed-a7c8-5d1ffdad966a',
      'https://github.com/user-attachments/assets/dc0c4923-e7da-4c09-8a21-a14b7e2a638e',
      'https://github.com/user-attachments/assets/ad508223-5cfd-49b1-8b75-b365d95679c5',
    ]
  },
  {
  ...
  essenciais sobre a cerimônia, como a <span style="font-style: italic;">data</span>, <span style="font-style: italic;">horário</span>
  e <span style="font-style: italic;">endereço do evento</span>.
</p>
<br>
<p>
  Além disso, incluímos uma <b>sessão especial para os presentes,</b> permitindo aos convidados contribuir de forma significativa
  para o casal. Essa funcionalidade estava conectada ao <b>projeto de lua de mel</b> que Isabella e Mauricio planejavam realizar,
  tornando a experiência ainda mais pessoal e marcante.
</p>
<br>
<p>
  O design foi pensado para refletir a <b>essência do casal,</b> com uma navegação <b>simples, moderna e intuitiva,</b> garantindo que
  todos os detalhes do grande dia estivessem ao alcance dos convidados.
</p>`,
    images: [
      'https://github.com/user-attachments/assets/d40c7a87-22bb-4742-98de-35f111bfa434',
      'https://github.com/user-attachments/assets/9a0a4819-45ca-4fc0-a8ca-aff3001b3299',
      'https://github.com/user-attachments/assets/76be630b-c331-4c3b-b48e-14a7edfe6ed0',
    ]
  },
  {
    title: 'Site de Casamento',
  ...
  essenciais sobre a cerimônia, como <span style="font-style: italic;">datas</span>, <span style="font-style: italic;">horários</span>
  e <span style="font-style: italic;">endereços</span>, de forma clara e acessível.
</p>
<br>
<p>
  Uma funcionalidade especial foi a <b>sessão de presentes,</b> onde os convidados puderam contribuir diretamente para o
  <b>projeto de lua de mel do casal,</b> tornando esse sonho ainda mais próximo. Além disso, disponibilizamos um formulário
  de <b>confirmação de presença (RSVP),</b> garantindo praticidade para os convidados e para o planejamento do evento.
</p>
<br>
<p>
  Pensando na organização, implementamos uma <b>visão administrativa</b> voltada para a assessoria do casamento.
  Esse painel permitiu <span style="font-style: italic;">filtrar convidados</span>, acessar <span style="font-style: italic;">informações de contato</span>,
  <span style="font-style: italic;">confirmar presenças</span> e gerar <b>listas em formato PDF</b> com a relação completa dos convidados,
  facilitando a logística e garantindo um evento impecável.
</p>
<br>
<p>
  Combinando <b>funcionalidade, elegância e praticidade,</b> o site se destacou como uma extensão do grande dia de Wendell e Pamela.
</p>`,
    images: [
      'https://github.com/user-attachments/assets/f5fb7ce1-4bdc-4768-8daa-8ba4c4b7884d',
      'https://github.com/user-attachments/assets/747595f2-eb99-4c04-88ee-3eaf0e5a10f1',
      'https://github.com/user-attachments/assets/3a90c575-d4cc-45cf-a0b0-c5b50c280344',
      'https://github.com/user-attachments/assets/f57c1aa0-028d-41c0-bb54-e94dfe1f149f',
